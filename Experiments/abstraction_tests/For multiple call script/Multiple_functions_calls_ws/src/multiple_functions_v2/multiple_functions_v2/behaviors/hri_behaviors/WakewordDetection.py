...
class WakewordDetection(py_trees.behaviour.Behaviour):
    ...
    def setup(self, **kwargs) -> None:
        ...
        try: 
            ...
            kw_path0 = os.path.join(current_path, "src/multiple_functions/multiple_functions/config/keyworddetection/Hey-Spot_en_linux_v3_0_0.ppn")
            kw_path1 = os.path.join(current_path, "src/multiple_functions/multiple_functions/config/keyworddetection/Hello-Spot_en_linux_v3_0_0.ppn")
    ...
    def update(self) -> Status:
        try: 
            if self.keyword_detected == True: 
                self.feedback_message = "Keyword detected: Hey Spot!"
