...
#include "proto2ros/msg/detail/list__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = proto2ros::msg::List;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const proto2ros::msg::List *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<proto2ros::msg::List *>(
    untyped_ros_message);
...
{
  return &proto2ros::msg::typesupport_fastrtps_cpp::_List__handle;
}
