...
#include "proto2ros/msg/detail/list__rosidl_typesupport_fastrtps_c.h"
...
#include "proto2ros/msg/detail/value__functions.h"  // values
...
using _List__ros_msg_type = proto2ros__msg__List;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: values
  {
    ...
    if (ros_message->values.data) {
      proto2ros__msg__Value__Sequence__fini(&ros_message->values);
    }
...
size_t get_serialized_size_proto2ros__msg__List(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _List__ros_msg_type * ros_message = static_cast<const _List__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _List__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_proto2ros__msg__List(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_proto2ros
size_t max_serialized_size_proto2ros__msg__List(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = proto2ros__msg__List;
    is_plain =
      (
...
static size_t _List__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_proto2ros__msg__List(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, proto2ros, msg, List)() {
