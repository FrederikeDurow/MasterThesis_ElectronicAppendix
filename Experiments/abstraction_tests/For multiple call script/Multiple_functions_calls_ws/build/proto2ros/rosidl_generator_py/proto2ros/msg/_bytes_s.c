...
bool proto2ros__msg__bytes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("proto2ros.msg._bytes.Bytes", full_classname_dest, 26) == 0);
  }
  proto2ros__msg__Bytes * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of Bytes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("proto2ros.msg._bytes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Bytes");
