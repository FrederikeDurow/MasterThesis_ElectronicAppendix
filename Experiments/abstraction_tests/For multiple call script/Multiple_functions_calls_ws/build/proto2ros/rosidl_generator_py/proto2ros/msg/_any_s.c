...
bool proto2ros__msg__any__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("proto2ros.msg._any.Any", full_classname_dest, 22) == 0);
  }
  proto2ros__msg__Any * ros_message = _ros_message;
  {  // type_name
...
{
  /* NOTE(esteve): Call constructor of Any */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("proto2ros.msg._any");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Any");
