...
class List(metaclass=Metaclass_List):
    ...
    _fields_and_field_types = {
        'values': 'sequence<proto2ros/Value>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['proto2ros', 'msg'], 'Value')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Value) for v in value) and
                 True), \
                "The 'values' field must be a set or sequence and each value of type 'Value'"
        self._values = value
