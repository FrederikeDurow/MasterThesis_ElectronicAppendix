...
def main():
    ...
    # navigator.waitUntilNav2Active(localizer="rtabmap")
    ...
    goal_pose1.pose.position.x = 4.123695373535156
    goal_pose1.pose.position.y = -2.4020678997039795
...
#    goal_pose2.pose.position.x = 5.491644382476807
#    goal_pose2.pose.position.y = 2.7653961181640625
...
#    goal_pose3.pose.position.x = 4.757437705993652
#    goal_pose3.pose.position.y = 9.010248184204102
